        ...
        child: Column(children: <Widget>[
          ...
          member != null
              ? Card(
                  ...
                  child: ListTile(
                    trailing: Text(
                      '${member.lastUpdate.substring(0, 5)}:Pembaruan terakhir',
                    ...
                    leading: Text(
                      '${member.nextUpdate.substring(0, 5)}:Pembaruan berikutnya',
                      textAlign: TextAlign.right,
                    ),
                  ))
              : Container(),
              ...
              ? Card(
                    child: ListTile(
                      ...
                      subtitle: member.grpCount != 0
                          ? Text('${member.grpCount} : Jumlah leader')
                          : Text(''),
                      trailing: Column(
                        children: <Widget>[
                          //  Row(children: <Widget>[],),
                          Text(
                              '${member.perBp.toInt().toString()}  : Bp pribadi'),
                          Text('${member.grpBp.toInt().toString()}  : Bp grup')
                        ],
                      ),
                    ),
                  ) ??
